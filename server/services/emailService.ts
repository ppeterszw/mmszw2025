      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="documents-section">
            <h3 style="color: #d97706; margin-top: 0;">📋 Required Documents Checklist</h3>
          ...
          <div class="important-note">
            <strong>💡 Important:</strong> All documents must be clear, legible, and in digital format (PDF, JPG, or PNG). Maximum file size: 5MB per document.
          </div>
